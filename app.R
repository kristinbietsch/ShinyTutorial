...
server <- function(input, output, session) {
  ...
  observeEvent(input$ChoRegion,{
    
    updateNumericInput(session,'R',
                       value=(data$R[data$Region==input$ChoRegion]))
  ...
  dat<-reactive({
    ...
    population <- data %>% mutate(Pop2021=Pop2020*exp((input$R/100) * 1),
                                  Pop2022=Pop2020*exp((input$R/100) * 2),
                                  Pop2023=Pop2020*exp((input$R/100) * 3),
                                  Pop2024=Pop2020*exp((input$R/100) * 4),
                                  Pop2025=Pop2020*exp((input$R/100) * 5),
                                  Pop2026=Pop2020*exp((input$R/100) * 6),
                                  Pop2027=Pop2020*exp((input$R/100) * 7),
                                  Pop2028=Pop2020*exp((input$R/100) * 8),
                                  Pop2029=Pop2020*exp((input$R/100) * 9),
                                  Pop2030=Pop2020*exp((input$R/100) * 10)) %>% 
